...
static std::vector<std::string> s_Preset_print_options {
    ...
    "travel_short_distance_acceleration",  "carbon_fiber_parallel_line_spacing",
...
static std::vector<std::string> s_Preset_printer_options {
    ...
    "machine_limits_usage", "thumbnails", "thumbnails_format", "nozzle_high_flow", "extruder_clearance_radius",
    "extruder_clearance_height", "carbon_fiber_pre_extrude_length",
    "carbon_fiber_cut_reserve_length"
};
